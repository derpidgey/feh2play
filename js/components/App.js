...
const App = () => {
  ...
  const team1 = [
    createBuild(UNIT.SAIZO.id, [SKILLS.MIGHT_OF_MIRIADS.id, SKILLS.SAIZOS_STAR.id + "_REFINE_EFF", SKILLS.SWAP.id, SKILLS.GLIMMER.id, SKILLS.FURY_3.id, SKILLS.VANTAGE_3.id, SKILLS.DRIVE_SPD_2.id, SKILLS.FURY_3.id + "_SEAL"]),
