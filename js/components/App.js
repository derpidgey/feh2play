...
const App = () => {
  ...
  const team1 = [
    createBuild(UNIT.SAIZO.id, [SKILLS.MIGHT_OF_MIRIADS.id, SKILLS.SAIZOS_STAR.id + "_REFINE_EFF", SKILLS.REPOSITION.id, SKILLS.GLIMMER.id, SKILLS.FURY_3.id, SKILLS.VANTAGE_3.id, SKILLS.DRIVE_SPD_2.id, SKILLS.FURY_3.id + "_SEAL"]),
    ...
    createBuild(UNIT.FAE.id, [SKILLS.ETERNAL_BREATH.id + "_REFINE_EFF", SKILLS.REPOSITION.id, SKILLS.GLIMMER.id, SKILLS.CLOSE_DEF_3.id, SKILLS.GUARD_3.id, SKILLS.INFANTRY_PULSE_3.id, SKILLS.QUICK_RIPOSTE_3.id + "_SEAL"]),
    ...
    createBuild(UNIT.CAEDA.id, [SKILLS.WING_SWORD.id + "_REFINE_EFF", SKILLS.REPOSITION.id, SKILLS.ICEBERG.id, SKILLS.FURY_3.id, SKILLS.HIT_AND_RUN.id, SKILLS.GUIDANCE_3.id, SKILLS.DRIVE_ATK_2.id + "_SEAL"])
  ];
  const team2 = [
