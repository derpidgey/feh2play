...
const App = () => {
  ...
  const team1 = [
    createBuild(UNIT.SAIZO.id, [SKILLS.MIGHT_OF_MIRIADS.id, SKILLS.SAIZOS_STAR.id + "_REFINE_EFF", SKILLS.REPOSITION.id, SKILLS.MOONBOW.id, SKILLS.FURY_3.id, SKILLS.VANTAGE_3.id, SKILLS.SAVAGE_BLOW_3.id, SKILLS.FURY_3.id + "_SEAL"]),
