...
const App = () => {
  ...
  const team1 = [
    createBuild(UNIT.FAE.id, [SKILLS.ADROIT_CAPTAIN.id, SKILLS.ETERNAL_BREATH.id + "_REFINE_EFF", SKILLS.REPOSITION.id, SKILLS.GLIMMER.id, SKILLS.CLOSE_DEF_3.id, SKILLS.GUARD_3.id, SKILLS.INFANTRY_PULSE_3.id, SKILLS.QUICK_RIPOSTE_3.id + "_SEAL"]),
