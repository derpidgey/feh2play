...
const BOOK_1 = {
  ...
  VIRION: {
    name: "Virion",
    subtitle: "Elite Archer",
    imgFace: "assets/face/book1/Virion_Elite_Archer_Face_FC.webp",
    imgSprite: "assets/sprites/book1/Virion_Elite_Archer_Mini_Unit_Idle.webp",
    rarity: RARITY.THREE_STAR,
    weaponType: WEAPON_TYPE.C_BOW.id,
    moveType: MOVE_TYPE.INFANTRY.id,
    entry: [ENTRY.AWAKENING],
    releaseDate: "2017-02-02",
    version: "1.0",
    level1Stats: { hp: 20, atk: 7, spd: 7, def: 7, res: 3 },
    level40Stats: { hp: 46, atk: 31, spd: 31, def: 26, res: 13 },
    superboons: [STATS.DEF, STATS.RES],
    superbanes: []
  },
  WRYS: {
