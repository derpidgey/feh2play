  ...
  SWORDBREAKER_3: {
    ...
    canUse: {
      weaponType: [
        ...
        WEAPON_TYPE.RED_BOW.id, WEAPON_TYPE.BLUE_BOW.id, WEAPON_TYPE.C_BOW.id,
        WEAPON_TYPE.RED_DAGGER.id, WEAPON_TYPE.BLUE_DAGGER.id, WEAPON_TYPE.C_DAGGER.id,
        WEAPON_TYPE.RED_TOME.id, WEAPON_TYPE.BLUE_TOME.id, WEAPON_TYPE.C_TOME.id,
        WEAPON_TYPE.RED_BREATH.id, WEAPON_TYPE.BLUE_BREATH.id, WEAPON_TYPE.C_BREATH.id,
        WEAPON_TYPE.RED_BEAST.id, WEAPON_TYPE.BLUE_BEAST.id, WEAPON_TYPE.C_BEAST.id
      ]
    }
  },
  LANCEBREAKER_3: {
    ...
    canUse: {
      weaponType: [
        ...
        WEAPON_TYPE.GREEN_BOW.id, WEAPON_TYPE.BLUE_BOW.id, WEAPON_TYPE.C_BOW.id,
        WEAPON_TYPE.GREEN_DAGGER.id, WEAPON_TYPE.BLUE_DAGGER.id, WEAPON_TYPE.C_DAGGER.id,
        WEAPON_TYPE.GREEN_TOME.id, WEAPON_TYPE.BLUE_TOME.id, WEAPON_TYPE.C_TOME.id,
        WEAPON_TYPE.GREEN_BREATH.id, WEAPON_TYPE.BLUE_BREATH.id, WEAPON_TYPE.C_BREATH.id,
        WEAPON_TYPE.GREEN_BEAST.id, WEAPON_TYPE.BLUE_BEAST.id, WEAPON_TYPE.C_BEAST.id
      ]
    }
  },
  AXEBREAKER_3: {
    ...
    canUse: {
      weaponType: [
        ...
        WEAPON_TYPE.RED_BOW.id, WEAPON_TYPE.GREEN_BOW.id, WEAPON_TYPE.C_BOW.id,
        WEAPON_TYPE.RED_DAGGER.id, WEAPON_TYPE.GREEN_DAGGER.id, WEAPON_TYPE.C_DAGGER.id,
        WEAPON_TYPE.RED_TOME.id, WEAPON_TYPE.GREEN_TOME.id, WEAPON_TYPE.C_TOME.id,
        WEAPON_TYPE.RED_BREATH.id, WEAPON_TYPE.GREEN_BREATH.id, WEAPON_TYPE.C_BREATH.id,
        WEAPON_TYPE.RED_BEAST.id, WEAPON_TYPE.GREEN_BEAST.id, WEAPON_TYPE.C_BEAST.id
      ]
    }
  },
  BOWBREAKER_3: {
